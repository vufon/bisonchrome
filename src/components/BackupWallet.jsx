export default function BackupWallet({ setPage }) {
  return (
    <div className="card backup-card mb-0">
      ...
      <p className="flex-center info text-danger text-center my-2">Write down your seed phrases and keep it in a safe place. Do not share your backup with anyone.</p>
    </div>
  )
}