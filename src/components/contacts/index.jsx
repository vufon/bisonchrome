...
import { ModalInput, InputFlex } from '../common/Inputs';
...
import { getContactAddressError, getContactNameError } from '../../validation/index';
import {
    ContactList,
    ContactsPanel,
    Row,
...
export default function Contacts({ setSendPage }) {
    ...
    const deleteContact = async () => {
        ...
        // Update localforage and state
        await updateDecredState('contactList', updatedContactList);
    ...
    const exportContactList = contactListArray => {
        ...
        csvLink.setAttribute(
            'download',
            'Decred_Contacts_' + wallet.name + '.csv',
        );
            ...
            {showAddNewContactModal && (
                ...
                >
                    <InputFlex>
                        ...
                        />
                        <ModalInput
                            placeholder="Enter new Decred address"
